...
# parser.add_argument('--image_path', default='dataset\\VOC\\images\\val',type=str, help="path of images")
# parser.add_argument('--label_path', default='dataset\\VOC\\labels\\val',type=str, help="path of labels .txt")
# parser.add_argument('--save_path', default='dataset\\annotations\\val.json', type=str, help="if not split the dataset, give a path to a json file")
...
parser = argparse.ArgumentParser()
parser.add_argument('--image_path', default='datasets\\VOC\\train2007', type=str, help="path of images")
parser.add_argument('--label_path', default='datasets\\VOC\\labels\\train', type=str, help="path of labels .txt")
parser.add_argument('--save_path', default='datasets\\VOC\\annotations\\train.json', type=str, help="if not split the dataset, give a path to a json file")
arg = parser.parse_args()
